...
fetch(url).then(parsedJson).then(function(parsedResponse) {
    var urls = parsedResponse.results.map(function(result) {
        return result.url;
    });
    var fetches = urls.map(function(url1) {
...
},{}]},["7fmqN","8lqZg"], "8lqZg", "parcelRequire82b7")
